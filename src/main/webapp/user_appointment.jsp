		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="card my-card">
					<div class="card-body">
						<p class="text-center fs-3 my-p-color">Book an Appointment</p>
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<c:if test="${empty userObj}">
								<div class="col-md-12">
									<a href="user_login.jsp" class="btn btn-primary text-white col-md-12">Submit</a>
								</div>
							</c:if>
							...
							<c:if test="${not empty userObj}">
								...
								<div class="col-md-12">
									<button type="submit" class="btn btn-primary text-white col-md-12">Submit</button>
								</div>
