...
<body>
	...
	<div class="container p-3">
		<p class="text-center mt-2 mb-5 fs-2 my-p-color">Key Features of our Healthcare Management System</p>
		<div class="row">
			<!-- 1st col -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 my-p-color">11000+ Healing Hands</p>
					...
					<div class="col-md-6">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 my-p-color">Most Advance Healthcare Technology</p>
					...
					<div class="col-md-6 mt-2">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 my-p-color">Best Clinical Outcomes</p>
					...
					<div class="col-md-6 mt-2">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 my-p-color">500+ Pharmacies</p>
