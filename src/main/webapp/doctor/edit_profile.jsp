		...
		<div class="row">
			<div class="col-md-4">
				<div class="card my-card">
					...
					<div class="card-body">
						<p class="fs-3 text-center my-p-color">Change Password</p>
			...
			<div class="col-md-6  offset-md-2">
				<div class="card my-card">
					...
					<div class="card-body">
						<p class="fs-3 text-center my-p-color">Edit Profile</p>
						...
						<!-- end of message -->
							...
							<form action="../doctorEditProfile" method="post">
								...
								<button type="submit"
									class="btn btn-primary text-white col-md-12">Update</button>
							</form>
