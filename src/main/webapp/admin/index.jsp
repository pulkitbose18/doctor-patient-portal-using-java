...
<body>
	...
	<div class="container p-5">
		<p class="text-center my-p-color fs-3">Admin Control Panel</p>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card my-card">
					<div class="card-body text-center my-p-color">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title my-p-color" id="exampleModalLabel">Add Specialist</h5>
